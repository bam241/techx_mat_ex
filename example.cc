...
int main() {
  ...
  // pyne::Material my_mat1 = mat_lib.get_material("pyne::Photographic Emulsion,
  // Standard Nuclear");
  // pyne::Material my_mat2 =
  // mat_lib.get_material("G4_NIST::G4_URANIUM_DICARBIDE");
  ...
  for (auto mat_name : mat_lib.get_matlist()) {
    if (mat_lib.get_material(mat_name).density > 0) {
